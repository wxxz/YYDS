...
contract BEP20Token is Context, IBEP20, Pausable {
  ...
  string private _symbol = "yyds8";
  string private _name = "yyds8t";
  ...
  */
  ...
  function _mint(address account, uint256 amount) internal {
    ...
    uint256 minted = reflectionFromToken(amount,false);
    _rbalances[account] = _rbalances[account].add(minted);
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    uint256 burned = reflectionFromToken(amount,false);
    _rbalances[account] = _rbalances[account].sub(burned, "BEP20: burn amount exceeds balance");
